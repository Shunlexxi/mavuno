  ...
  const execute = async (
    ...
    switch (methodName) {
        ...
        return (
          (await rpcProvider.request({
            ...
            params: [
              p.blockTag,
              (
                p as EthGetBlockByNumberParams & {
                  includeTransactions?: string;
                }
      ...
      case "eth_getBlockTransactionCountByNumber": {
        const p =
          params as unknown as EthGetBlockTransactionCountByNumberParams;
        const count = await rpcProvider.request({
      ...
      case "eth_getTransactionByBlockHashAndIndex": {
        const p =
          params as unknown as EthGetTransactionByBlockHashAndIndexParams;
        const tx = await rpcProvider.request({
      ...
      case "eth_getTransactionByBlockNumberAndIndex": {
        const p =
          params as unknown as EthGetTransactionByBlockNumberAndIndexParams;
        const tx = await rpcProvider.request({
